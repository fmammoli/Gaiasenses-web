  ...
  return function (moduleArg = {}) {
    ...
    (() => {
      ...
      function loadPackage(metadata) {
        ...
        var PACKAGE_NAME =
          "/Users/fmammoli/Developer/zan-patches/humansparks/WebPatch/pd4web.data";
        ...
        function runWithFS(Module) {
          ...
          function processPackageData(arrayBuffer) {
            ...
            Module["removeRunDependency"](
              "datafile_/Users/fmammoli/Developer/zan-patches/humansparks/WebPatch/pd4web.data"
            );
          }
      ...
      loadPackage({
        files: [
          { filename: "/Libs/chplz.pd", start: 0, end: 2183 },
          { filename: "/Libs/comb1.pd", start: 2183, end: 2545 },
          { filename: "/Libs/randgate.pd", start: 2545, end: 3018 },
          { filename: "/Libs/snap.pd", start: 3018, end: 3790 },
          { filename: "/Libs/spark6formant.pd", start: 3790, end: 4620 },
          { filename: "/index.pd", start: 4620, end: 6281 },
        ],
        remote_package_size: 6281,
      });
    })();
