...
function sketch(p5: P5CanvasInstance<SketchProps & DigitalOrganismSketchProps>) {
...
export default function DigitalOrganismSketch(props: DigitalOrganismSketchProps) {
  return (
    <NextReactP5Wrapper
      sketch={sketch}
      {...props} />
